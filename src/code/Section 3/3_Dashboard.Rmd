...
```{r, include=FALSE}
ga_data = read.csv("Analytics 1 Master View New vs Returning 20170606-20170612.csv", sep=",", header=T)
# cleaning up data
...
```{r, include=FALSE}
# using example file
ga_data = read.csv("Analytics 1 Master View Frequency & Recency 20170414-20170614.csv", sep=",", header=T)
