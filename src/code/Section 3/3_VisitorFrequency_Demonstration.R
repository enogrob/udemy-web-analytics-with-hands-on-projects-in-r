...
ga_data = google_analytics_4(ga_id, date_range = c("2017-05-18", "2017-06-18"), metrics = c("ga:pageviews", "ga:users"), dimensions = c("ga:sessionCount"))
...
#ggplot2
ggplot(ga_data.toPlot, aes(x=Count.of.Sessions, y=Pageviews)) + geom_bar(stat="identity", width=0.6, fill="tomato3")